...
import styles from "../../styles/components/tables/UserInformationTable.module.css";
...
const UserInformationTable = ({ title, primaryUser, secondaryUser }) => {
  return (
